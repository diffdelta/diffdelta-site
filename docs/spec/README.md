...
|---|---|---|---|
| **Python** | clients/python/diffdelta_client.py | None (stdlib only) | ETag + disk cache |
| **TypeScript** | clients/typescript/diffdeltaClient.ts | None (fetch API) | ETag + in-memory cache |
